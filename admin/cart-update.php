<?php 
	...
	if ( !empty($_POST)) {
		...
		$sql = "UPDATE cart  set trangthai = 'Đa Duyet' where id_cart=?";
		$q = $pdo->prepare($sql);
...
<body>
    ...
    <section>
    	<div class="container">
				...
				<div class="row">
					<form class="form-horizontal" action="cart-update.php" method="post">
	    			  <input type="hidden" name="id_cart" value="<?php echo $id_cart;?>"/>
					  <p class="alert alert-error">Bạn có chắc muốn duyệt ?</p>
